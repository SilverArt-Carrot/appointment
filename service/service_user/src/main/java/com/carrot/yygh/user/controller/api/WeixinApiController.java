...
import com.carrot.yygh.user.utils.ConstantWxPropertiesUtils;
import com.carrot.yygh.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public String callback(String code, String state) {
        ...
        try {
            ...
            //如果邮箱不为空，返回openid值是空字符串
            //前端判断：如果openid不为空，绑定邮箱，如果openid为空，不需要绑定邮箱
